...
var async, dedupeOnHostPort, dedupedRequests, lookup, lookupdRequest, request, _;
...
dedupedRequests = function(lookupdEndpoints, urlFn, callback) {
  var endpoint, requestFns, url, urls;
...
lookup = function(lookupdEndpoints, topic, callback) {
  ...
  endpointURL = function(endpoint) {
    return "http://" + endpoint + "/lookup?topic=" + topic;
  };
