...
exports.identify = function(data) {
  ...
  validIdentifyKeys = ['short_id', 'long_id', 'feature_negotiation', 'heartbeat_interval', 'output_buffer_size', 'output_buffer_timeout', 'tls_v1', 'snappy'];
...
validTopicName = function(topic) {
  var _ref;
  return ((0 < (_ref = topic.length) && _ref < 33)) && (topic.match(/^[\.a-zA-Z0-9_-]+$/) != null);
};

validChannelName = function(channel) {
  var channelRe, _ref;
  channelRe = /^[\.a-zA-Z0-9_-]+(#ephemeral)?$/;
  return ((0 < (_ref = channel.length) && _ref < 33)) && (channel.match(channelRe) != null);
};
